  ...
  const posts = [
    {
      id: 1,
      category: "Painting",
      img: require("../images/House (2).jpg"),
      description: "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
    },
    {
      id: 7,
      category: "Painting",
      img: require("../images/House (8).jpg"),
      description: "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
    },
    {
      id: 8,
      category: "Painting",
      img: require("../images/House (9).jpg"),
      description: "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
    },
    {
      id: 9,
      category: "Painting",
      img: require("../images/House (10).jpg"),
      description: "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
    },
    {
      id: 2,
      category: "Carpentry",
      img: require("../images/House (3).jpg"),
      description: "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
    },
    {
      id: 3,
      category: "Roofing",
      img: require("../images/House (4).jpg"),
      description: "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
    },
    {
      id: 4,
      category: "Interior Design",
      img: require("../images/House (5).jpg"),
      description: "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
    },
    {
      id: 5,
      category: "Smart Homes",
      img: require("../images/House (6).jpg"),
      description: "Lorem ipsum dolor sit amet consectetur adipisicing elit.",
    },
    {
      id: 6,
      ...
      <div className="gallery-container">
        ...
        <div className="bar">
          <div className="bar-item">
            ...
            <li onClick={() => setSelectedCategory("Smart Homes")}>
              Smart Homes
            </li>
            <li onClick={() => setSelectedCategory("Structural Repairs")}>
              Structural Repairs
            </li>
          </div>
        </div>
